        ...
        <div>
            <header className="sticky top-0">
                <nav className="ml-0  bg-gray-800 p-2">
                    <div className="container mx-auto flex justify-between items-center ml-0 mr-0 text-right ml-auto">
                        <Link href="#" className="text-white text-lg font-bold ml-0">Manyu</Link>
                        <div className="hidden md:flex space-x-4 mr-0 text-right">
                            ...
                            <div className="relative">
                                ...
                                {/* Dropdown Menu */}
                                {isOpen && (
                                    <div className="absolute right-0 mt-2 w-12 bg-white rounded-md shadow-lg  ml-0 mr-0 text-right ml-auto">
                                        <button
