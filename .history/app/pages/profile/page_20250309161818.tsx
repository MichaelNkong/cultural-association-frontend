                            ...
                            <div className="relative">
                                ...
                                {isOpen && (
                                    <ul className="absolute right-0 mt-2 w-40 bg-white rounded-md shadow-lg">
                                        ...
                                        <Link href = "/pages/priva" className="block w-full text-left px-4 py-2 text-gray-700 hover:bg-gray-100">
                                            Privacy
                                        </Link>
                                        <Link href="/" className="block w-full text-left px-4 py-2 text-gray-700 hover:bg-gray-100">
                                            Terms of Use
                                        </Link>
                                        <button
