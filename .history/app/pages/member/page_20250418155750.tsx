...
export default function MemberPage() {
  ...
  async function handleCheckboxChange(e: React.InputHTMLAttributes<HTMLInputElement>, user_id: number): Promise<void> {
    ...
    try {
      setIsChecked(e.formTarget.checked)
                    ...
                    {users.length > 0 ? (
                      ...
                      users.map((user, index) => (
                        <tr key={user.id}>
                          ...
                          <td>{user.email}</td>
                          <td>
                            <input type="checkbox"  checked={isChecked} name="selectRow"    onClick={(e) => handleCheckboxChange(e,user.id)}   />
                          </td>
                        </tr>
                      ))
                    ) : (
