...
export default function EventDetailPage() {
  ...
  useEffect(() => {
    ...
    setCanManage(Boolean(localStorage.getItem("token")));
  }, [params.id]);
    ...
    <main className="events-page">
      <div className="events-shell">
        ...
        <article className="event-detail">
          ...
          {canManage && <div className="event-detail__manage"><Link href={`/pages/events?edit=${event.id}`}>Edit event</Link><button type="button" onClick={handleDelete}>Delete event</button></div>}
        </article>
      </div>
    </main>
  );
